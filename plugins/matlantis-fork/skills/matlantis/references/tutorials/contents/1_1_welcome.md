...
対象読者は以下のような方です。
 ...
 - マテリアルズインフォマティクスなどの原子シミュレーションではない理系の専門知識をお持ちで、これから原子シミュレーションも理解を深めて使いこなしていこうとする方
 - 実験家の方で、今後、実験結果の説明など理論面からもアプローチするために計算も行っていきたい方

本チュートリアルのコードの多くは[Matlantis](https://matlantis.com/ja/)のシステム上で動くコードとなっており、
実際に動かすには製品の契約が必要となりますが、読み進めるだけでも勉強を進めていくことはできます。
...
本TutorialのコードはMatlantisのシステム上で動かすことができます。&lt;br/&gt;
[Matlantis](https://matlantis.com/ja/)は「革新的なマテリアルの創出に貢献し、持続可能な世界を実現する」ことをミッションに掲げる[Matlantis(株)](https://matlantis.com/ja/company)が提供する、**汎用原子レベルシミュレータ** です。
...
&lt;figure style="width:30%;float:left;margin:10px"&gt;
  ...
  &lt;figcaption style="text-align: center"&gt;汎用性&lt;/figcaption&gt;
&lt;/figure&gt;
&lt;figure style="width:30%;float:left;margin:10px"&gt;
  &lt;img src="https://matlantis.com/wp-content/themes/matlantis_theme/img/product/image_universal2.png"/&gt;
  &lt;figcaption style="text-align: center"&gt;高速&lt;/figcaption&gt;
&lt;/figure&gt;
&lt;figure style="width:30%;float:left;margin:10px"&gt;
  &lt;img src="https://matlantis.com/wp-content/themes/matlantis_theme/img/product/image_universal3.png"/&gt;
  &lt;figcaption style="text-align: center"&gt;使いやすさ&lt;/figcaption&gt;
&lt;/figure&gt;
&lt;/div&gt;

&lt;br/&gt;

**汎用性**があるポテンシャルを提供しており、幅広い元素や構造に対して計算ができることが大きな特徴です。
量子計算と比べて**高速**に計算を行うことができ、Jupyter Lab上でInteractiveに実行できるなど**使いやすい**ため、
試行錯誤を行いながらすぐに結果が得られ学習を進めるうえでも適しています。

中で使われているコア技術については、以下の参考文献も御覧ください。

 - [材料探索のためのユニバーサルなニューラルネットワークポテンシャル - Preferred Networks Research &amp; Development](https://tech.preferred.jp/ja/blog/development-of-universal-neural-network-for-materials-discovery/)
 - [Towards universal neural network potential for material discovery applicable to arbitrary combination of 45 elements](https://www.nature.com/articles/s41467-022-30687-9)
...
本チュートリアルを読んでいて不明な点が出てきた場合など、必要に応じて勉強すると良いでしょう。
 ...
 - **[8. NumPy](https://tutorials.chainer.org/ja/08_Introduction_to_NumPy.html)：ベクトル計算を効率よく行うためのライブラリ。科学計算をおこなうPythonプログラミングでは頻出します。**
 ...
 - **[11. Pandas](https://tutorials.chainer.org/ja/11_Introduction_to_Pandas.html)： 表形式にデータをまとめて、前処理・後処理・可視化などを行うことが出来るライブラリ。**
 - **[12. Matplotlib](https://tutorials.chainer.org/ja/12_Introduction_to_Matplotlib.html)： グラフ描画のためのライブラリ。**
...
それでは早速次節から実際にコードを動かしながら原子シミュレーションを学んでいきましょう。
