# matlantis_features.features.common.opt.LBFGSLineSearchASEOptFeature#

_class _matlantis_features.features.common.opt.LBFGSLineSearchASEOptFeature(_n_run : int = 200_, _fmax : float = 0.01_, _attach_methods : Optional[List[Tuple[Callable[[], None], int]]] = None_, _show_progress_bar : bool = False_, _tqdm_options : Optional[Dict[str, Any]] = None_, _show_logger : bool = False_, _logger_interval : int = 10_, _filter : Union[bool, [MatlantisFilter](../matlantis_features.filters.html#matlantis_features.filters.MatlantisFilter "matlantis_features.filters.MatlantisFilter")] = False_, _trajectory : Optional[str] = None_, _estimator_fn : Optional[Callable[[], Estimator]] = None_, _maxstep : float = 0.2_)[[source]](../_modules/matlantis_features/features/common/opt.html#LBFGSLineSearchASEOptFeature)#
...
`to_dict`() | Dictionary representation of the LBFGSLineSearchASEOptFeature.  
...
to_dict() → Dict[str, Any][[source]](../_modules/matlantis_features/features/common/opt.html#LBFGSLineSearchASEOptFeature.to_dict)#
...
A dict containing a serialized LBFGSLineSearchASEOptFeature.
...
[ __ previous matlantis_features.features.common.opt.LBFGSASEOptFeature ](matlantis_features.features.common.opt.LBFGSASEOptFeature.html "previous page") [ next matlantis_features.features.common.opt.MDMinASEOptFeature __](matlantis_features.features.common.opt.MDMinASEOptFeature.html "next page")
