...
_class _matlantis_features.features.base.FeatureBase[[source]](../_modules/matlantis_features/features/base.html#FeatureBase)#
...
__init__() → None[[source]](../_modules/matlantis_features/features/base.html#FeatureBase.__init__)#
    

Initialize an instance.

attach_ctx(_ctx : Optional[Context] = None_) → None[[source]](../_modules/matlantis_features/features/base.html#FeatureBase.attach_ctx)#
...
check_estimator_fn(_estimator_fn : Optional[Callable[[], Estimator]]_) → None[[source]](../_modules/matlantis_features/features/base.html#FeatureBase.check_estimator_fn)#
...
cost_estimate(_atoms : Optional[Union[Atoms, [MatlantisAtoms](../matlantis_features.atoms.html#matlantis_features.atoms.MatlantisAtoms "matlantis_features.atoms.MatlantisAtoms")]] = None_) → FeatureCost[[source]](../_modules/matlantis_features/features/base.html#FeatureBase.cost_estimate)#
...
_classmethod _from_dict(_res : Dict[str, Any]_) → FeatureBase[[source]](../_modules/matlantis_features/features/base.html#FeatureBase.from_dict)#
...
get_savedir_from_ctx() → Path[[source]](../_modules/matlantis_features/features/base.html#FeatureBase.get_savedir_from_ctx)#
...
init_scope() → Iterator[None][[source]](../_modules/matlantis_features/features/base.html#FeatureBase.init_scope)#
...
repeat(_n_repeat : int_) → Self[[source]](../_modules/matlantis_features/features/base.html#FeatureBase.repeat)#
...
to_dict() → Dict[str, Any][[source]](../_modules/matlantis_features/features/base.html#FeatureBase.to_dict)#
...
[ __ previous matlantis_features.features.base ](matlantis_features.features.base.html "previous page") [ next matlantis_features.features.base.FeatureBaseCaller __](matlantis_features.features.base.FeatureBaseCaller.html "next page")
