...
---|---  
`__call__`(atoms[, indices]) | Calculate the hessian matrix.  
...
__init__(_delta : float = 0.01_, _nfree : int = 2_, _method : str = 'standard'_, _direction : str = 'central'_, _show_progress_bar : bool = False_, _tqdm_options : Optional[Dict[str, Any]] = None_, _show_logger : bool = False_, _estimator_fn : Optional[Callable[[], Estimator]] = None_, _num_threads : int = 20_) → None[[source]](../_modules/matlantis_features/features/common/hessian.html#HessianFeature.__init__)#
...
__call__(_atoms : Union[[MatlantisAtoms](../matlantis_features.atoms.html#matlantis_features.atoms.MatlantisAtoms "matlantis_features.atoms.MatlantisAtoms"), Atoms]_, _indices : Optional[List[int]] = None_) → [HessianFeatureResult](matlantis_features.features.common.hessian.HessianFeatureResult.html#matlantis_features.features.common.hessian.HessianFeatureResult "matlantis_features.features.common.hessian.HessianFeatureResult")#
...
[HessianFeatureResult](matlantis_features.features.common.hessian.HessianFeatureResult.html#matlantis_features.features.common.hessian.HessianFeatureResult "matlantis_features.features.common.hessian.HessianFeatureResult")
...
[ __ previous matlantis_features.features.common.hessian ](matlantis_features.features.common.hessian.html "previous page") [ next matlantis_features.features.common.hessian.HessianFeatureResult __](matlantis_features.features.common.hessian.HessianFeatureResult.html "next page")
