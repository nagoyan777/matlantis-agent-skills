# matlantis_features.features.common.opt.OptFeatureBase#

_class _matlantis_features.features.common.opt.OptFeatureBase[[source]](../_modules/matlantis_features/features/common/opt.html#OptFeatureBase)#
...
This class is inherited by other optimizer features, and not intended to be used directly.
...
**atoms** (_ASEAtoms_ _or_[ _MatlantisAtoms_](../matlantis_features.atoms.html#matlantis_features.atoms.MatlantisAtoms "matlantis_features.atoms.MatlantisAtoms")) – The system to be optimized.

Returns
    

A dataclass containing information about the result of optimization. Raises a NotImplementedError in the base class.
...
to_dict() → Dict[str, Any][[source]](../_modules/matlantis_features/features/common/opt.html#OptFeatureBase.to_dict)#
...
[ __ previous matlantis_features.features.common.opt.OptFeatureResult ](matlantis_features.features.common.opt.OptFeatureResult.html "previous page") [ next matlantis_features.features.common.opt.OptFeatureOutput __](matlantis_features.features.common.opt.OptFeatureOutput.html "next page")
