# matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosity#

_class _matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosity[[source]](../_modules/matlantis_features/features/md/post_features/nemd_viscosity.html#PostNEMDViscosity)#
    

Bases: [`PostNEMDViscosityFeature`](matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosityFeature.html#matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosityFeature "matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosityFeature")

The old version of PostNEMDViscosityFeature. This class is deprecated. Please use PostNEMDViscosityFeature instead.

Methods

`__init__`() | Initialize an instance.  
---|---  
`__call__`(md_results[, init_time]) | Calculate the viscosity from the non-equilibrium MD trajectory.  
...
__init__() → None[[source]](../_modules/matlantis_features/features/md/post_features/nemd_viscosity.html#PostNEMDViscosity.__init__)#
    

Initialize an instance.

__call__(_md_results : [MDFeatureResult](matlantis_features.features.md.md.MDFeatureResult.html#matlantis_features.features.md.md.MDFeatureResult "matlantis_features.features.md.md.MDFeatureResult")_, _init_time : float = 0.0_) → [PostNEMDViscosityFeatureResult](matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosityFeatureResult.html#matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosityFeatureResult "matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosityFeatureResult")#
...
Parameters
  ...
  * **md_results** ([_MDFeatureResult_](matlantis_features.features.md.md.MDFeatureResult.html#matlantis_features.features.md.md.MDFeatureResult "matlantis_features.features.md.md.MDFeatureResult")) – MD feature’s result object containing the trajectory. The simulation must be run with the rNEMD extension.
...
[PostNEMDViscosityFeatureResult](matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosityFeatureResult.html#matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosityFeatureResult "matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosityFeatureResult")
...
[ __ previous matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosityFeatureResult ](matlantis_features.features.md.post_features.nemd_viscosity.PostNEMDViscosityFeatureResult.html "previous page") [ next matlantis_features.features.md.post_features.nemd_thermal_conductivity __](matlantis_features.features.md.post_features.nemd_thermal_conductivity.html "next page")
