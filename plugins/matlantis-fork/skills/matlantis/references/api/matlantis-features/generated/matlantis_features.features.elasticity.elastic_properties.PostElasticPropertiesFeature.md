# matlantis_features.features.elasticity.elastic_properties.PostElasticPropertiesFeature#

_class _matlantis_features.features.elasticity.elastic_properties.PostElasticPropertiesFeature[[source]](../_modules/matlantis_features/features/elasticity/elastic_properties.html#PostElasticPropertiesFeature)#
...
Including bulk modulus, shear modulus, Young’s modulus, poisson ratio etc.

Methods

`__init__`() | Initialize an instance.  
---|---  
`__call__`(elastic_tensor) | Call function.  
...
**elastic_tensor** ([_ElasticTensor_](matlantis_features.features.elasticity.elastic_tensor.ElasticTensor.html#matlantis_features.features.elasticity.elastic_tensor.ElasticTensor "matlantis_features.features.elasticity.elastic_tensor.ElasticTensor")) – Elastic tensor object calculated by ElasticTensorFeature.

Returns
    

Resulting elastic properties object.

Return type
    

[ElasticProperties](matlantis_features.features.elasticity.elastic_properties.ElasticProperties.html#matlantis_features.features.elasticity.elastic_properties.ElasticProperties "matlantis_features.features.elasticity.elastic_properties.ElasticProperties")
...
[ __ previous matlantis_features.features.elasticity.elastic_properties ](matlantis_features.features.elasticity.elastic_properties.html "previous page") [ next matlantis_features.features.elasticity.elastic_properties.ElasticProperties __](matlantis_features.features.elasticity.elastic_properties.ElasticProperties.html "next page")
