# matlantis_features.features.common.opt.FireASEOptFeature#

_class _matlantis_features.features.common.opt.FireASEOptFeature(_n_run : int = 200_, _fmax : float = 0.01_, _attach_methods : Optional[List[Tuple[Callable[[], None], int]]] = None_, _show_progress_bar : bool = False_, _tqdm_options : Optional[Dict[str, Any]] = None_, _show_logger : bool = False_, _logger_interval : int = 10_, _filter : Union[bool, [MatlantisFilter](../matlantis_features.filters.html#matlantis_features.filters.MatlantisFilter "matlantis_features.filters.MatlantisFilter")] = False_, _trajectory : Optional[str] = None_, _estimator_fn : Optional[Callable[[], Estimator]] = None_, _maxstep : float = 0.2_)[[source]](../_modules/matlantis_features/features/common/opt.html#FireASEOptFeature)#
...
For details of the FIRE algorithm, please see: Guénolé et al., Comput. Mater. Sci. 175 (2020) 109584.

Methods

`__init__`([n_run, fmax, attach_methods, ...]) | Initialize an instance.  
---|---  
...
`to_dict`() | Dictionary representation of the FireASEOptFeature.  
  
__init__(_n_run : int = 200_, _fmax : float = 0.01_, _attach_methods : Optional[List[Tuple[Callable[[], None], int]]] = None_, _show_progress_bar : bool = False_, _tqdm_options : Optional[Dict[str, Any]] = None_, _show_logger : bool = False_, _logger_interval : int = 10_, _filter : Union[bool, [MatlantisFilter](../matlantis_features.filters.html#matlantis_features.filters.MatlantisFilter "matlantis_features.filters.MatlantisFilter")] = False_, _trajectory : Optional[str] = None_, _estimator_fn : Optional[Callable[[], Estimator]] = None_, _maxstep : float = 0.2_)[[source]](../_modules/matlantis_features/features/common/opt.html#FireASEOptFeature.__init__)#
...
to_dict() → Dict[str, Any][[source]](../_modules/matlantis_features/features/common/opt.html#FireASEOptFeature.to_dict)#
...
A dict containing a serialized FireASEOptFeature.
...
[ __ previous matlantis_features.features.common.opt.BFGSLineSearchASEOptFeature ](matlantis_features.features.common.opt.BFGSLineSearchASEOptFeature.html "previous page") [ next matlantis_features.features.common.opt.FireLBFGSASEOptFeature __](matlantis_features.features.common.opt.FireLBFGSASEOptFeature.html "next page")
