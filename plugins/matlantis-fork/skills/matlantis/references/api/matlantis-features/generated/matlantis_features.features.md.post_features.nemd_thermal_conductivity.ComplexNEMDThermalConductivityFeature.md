# matlantis_features.features.md.post_features.nemd_thermal_conductivity.ComplexNEMDThermalConductivityFeature#

_class _matlantis_features.features.md.post_features.nemd_thermal_conductivity.ComplexNEMDThermalConductivityFeature(_integrator : [MDIntegratorBase](matlantis_features.features.md.md_integrator_base.MDIntegratorBase.html#matlantis_features.features.md.md_integrator_base.MDIntegratorBase "matlantis_features.features.md.md_integrator_base.MDIntegratorBase")_, _n_run : int_, _rnemd_n_slab : int = 20_, _rnemd_interval : int = 100_, _init_time : float = 0.0_, _md_feature_args : Optional[Dict[str, Any]] = None_)[[source]](../_modules/matlantis_features/features/md/post_features/nemd_thermal_conductivity.html#ComplexNEMDThermalConductivityFeature)#
...
`__init__`(integrator, n_run[, rnemd_n_slab, ...]) | Create the feature object.  
---|---  
`__call__`(system) | Run the rNEMD simulation and calculate the thermal conductivity.  
...
__call__(_system : [MDSystemBase](matlantis_features.features.md.md_system_base.MDSystemBase.html#matlantis_features.features.md.md_system_base.MDSystemBase "matlantis_features.features.md.md_system_base.MDSystemBase")_) → [ComplexNEMDThermalConductivityFeatureResult](matlantis_features.features.md.post_features.nemd_thermal_conductivity.ComplexNEMDThermalConductivityFeatureResult.html#matlantis_features.features.md.post_features.nemd_thermal_conductivity.ComplexNEMDThermalConductivityFeatureResult "matlantis_features.features.md.post_features.nemd_thermal_conductivity.ComplexNEMDThermalConductivityFeatureResult")#
...
[ComplexNEMDThermalConductivityFeatureResult](matlantis_features.features.md.post_features.nemd_thermal_conductivity.ComplexNEMDThermalConductivityFeatureResult.html#matlantis_features.features.md.post_features.nemd_thermal_conductivity.ComplexNEMDThermalConductivityFeatureResult "matlantis_features.features.md.post_features.nemd_thermal_conductivity.ComplexNEMDThermalConductivityFeatureResult")
